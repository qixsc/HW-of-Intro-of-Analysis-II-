...
\begin{enumerate}
    ...
    For any $\epsilon > 0$, we can find $\delta > 0$ s.t. $\|Df(x) - Df(y)\| < \dfrac{\epsilon}{\|b-a \|}$ for $\| x-y\| < \delta$.
    Then, we can find $\{x_i\}_{i=1}^n$ s.t. $\cup D(x_i, \delta) \subseteq S$.
    \begin{align*}
        \|f(b) - f(a) - \displaystyle\sum_{i=1}^{n} \| &=
    \end{align*}
