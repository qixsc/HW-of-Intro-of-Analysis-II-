...
\begin{enumerate}
    ...
    \item For any $(x_0, y_0)\in \mathbb{R}^2$ and $\epsilon > 0$, we can find small enough $h, k$ s.t. $|f_{xy}(x_0, y_0) - \dfrac{f_x(x_0, y_0 + k) - f_x(x_0, y_0)}{k}| < \epsilon$ and so as $f_x(x_0, y_0)$ and $f_y(x_0, y_0)$.

    Then, \begin{align*}
        |\dfrac{f_y(x_0+h, y_0) - f_y(x_0, y_0)}{h}| &\leq \dfrac{1}{|h|}\cdot \left|\dfrac{f(x_0+h, y_0 + k) - f(x_0+h, y_0)}{k} - \dfrac{f(x_0, y_0 + k) - f(x_0, y_0)}{k}\right| + 2\dfrac{\epsilon}{|h|}\\
        &\leq \dfrac{2\epsilon + 2|k|\epsilon}{|h||k|} + \dfrac{1}{|k|}\left(\left| \dfrac{f(x_0 + h, y_0 + k) - f(x_0, y_0 + k)}{h} - \dfrac{f(x_0+ h, y_0) - f(x_0, y_0)}{h}\right|\right)\\
        &\leq \dfrac{2}{\epsilon} + \dfrac{1}{|k|}
    \end{align*}
\end{enumerate}
\end{document} 