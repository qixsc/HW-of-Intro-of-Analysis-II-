...
\begin{enumerate}
    ...
    Then, let $g(x) = \displaystyle\int_{0}^{x} Df(a + t(b-a))(b-a) dt$.
    For any $\epsilon > 0$, we can find $\delta > 0$ s.t. $\|Df(x) - Df(y)\| < \dfrac{\epsilon}{\displaystyle\sup_{s\in S} |Df(s)|}$ for $\| x-y\| < \delta$.
