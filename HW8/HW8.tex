...
\begin{enumerate}
    ...
    Then, \begin{align*}
        |\dfrac{f_y(x_0+h, y_0) - f_y(x_0, y_0)}{h}| &\leq \dfrac{1}{|h|}\cdot \left|\dfrac{f(x_0+h, y_0 + k) - f(x_0+h, y_0)}{k} - \dfrac{f(x_0, y_0 + k) - f(x_0, y_0)}{k}\right| + 2\epsilon\\
        &= \dfrac{2\epsilon}{|h|} + \dfrac{1}{|k|}\left(\left| \dfrac{f(x_0 + h, y_0 + k) - f(x_0, y_0 + k)}{h} - \dfrac{f(x_0+ h, y_0) - f(x_0, y_0)}{h}\right|\right)\\
