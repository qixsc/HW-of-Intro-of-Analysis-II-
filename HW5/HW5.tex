...
\begin{enumerate}
    \item \begin{enumerate}
        ...
        $|\phi(x) - \phi(y)| < |\phi(x) - (\phi(x)+\delta)| = \epsilon$.
        Thus, $0 \leq \phi(x) \leq 1$ is continuous for all $x \in \mathbb{R}^n$.

        \item Let $\phi(x) = (b-a)\dfrac{d(x, A)}{d(x, A) + d(x, B)} + a$.
        From (a), we can get continuous funtion $\phi(x\in A) = (b-a)\cdot 0 + a = a$, $\phi(x\in B) = (b-a)\cdot 1 + a = b$,
