...
\begin{enumerate}
    ...
    Thus, by M.I., $T^m(u) = \dfrac{1}{(m-1)!}\displaystyle\int_{a}^{t} (t-s)^m u(s) ds \leq \displaystyle\int_{a}^{t} \dfrac{(t-s)^m}{(m-1)!} M ds \to 0$ 
    for $M$ is upper bound of $u$ and as $m\to \infty$.
