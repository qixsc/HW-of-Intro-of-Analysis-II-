...
\begin{enumerate}
    ...
    Thus, $T^m(u) = \dfrac{1}{(m-1)!}\displaystyle\int_{a}^{t} (t-s)^m u(s) ds \leq \displaystyle\int_{a}^{t} \dfrac{(t-s)^m}{(m-1)!} M\ ds \leq \displaystyle\int_{a}^{t} \dfrac{M\cdot (t-a)^m}{(m-1)!}\ ds$
    with $M$ is upper bound of $u$.
