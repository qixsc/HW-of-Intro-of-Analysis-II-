...
\begin{enumerate}
    ...
    \item Since $T(u)(t) = \displaystyle\int_a^t u(s)\ ds$,\begin{align*}
        T^2(u)(t) &= T(T(u))(t)\\ 
        &= \displaystyle\int_{a}^{t} T(u)(s)\ ds\\
        &= \displaystyle\int_{a}^{t} \displaystyle\int_{a}^{s} u(s)\ dx\ ds\\ 
        &= \displaystyle\int_{a}^{t} (t-s) u(s) ds
    \end{align*}
