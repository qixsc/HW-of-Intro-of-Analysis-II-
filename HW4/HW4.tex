...
\begin{enumerate}
    ...
    \item For any $\epsilon > 0$, there exists $\delta > 0$ s.t. $\| x-y\| < \delta \implies \| f_k(x) - f_k(y)\| < \dfrac{\epsilon}{2}$.
    Then, there exists $N \in \mathbb{N}$ s.t. $\| f(x) - f_k(x) \| < \dfrac{\epsilon}{2}$.
    Since $K$ is compact, 
