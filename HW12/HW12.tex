...
\begin{enumerate}
    \item \begin{enumerate}
        \item Since $E$ is Jordan region, $\volume(\partial E) = 0$.

        \item Since $\closure(E) = \interior(E) \cup \partial E$ and $\interior(E)\subseteq E \subseteq \closure(E)$,

        $\volume(\closure(E)) \leq \volume(\interior(E)) + \volume(\partial E) = \volume(\interior(E))\leq \volume(E) \leq \volume(\closure(E))$.
        ...
        And since $\partial A \subseteq A$, $\volume(\partial A) \leq \volume(A)$.
