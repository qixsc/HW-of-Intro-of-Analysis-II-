...
\begin{enumerate}
    ...
    \item $\ $\begin{enumerate}
        ...
        \item[($\impliedby$)] First, since $\dfrac{1}{n} \to 0$ and $\displaystyle\sum_{n=1}^{m} sin(nx) = \dfrac{\sin(\frac{mx}{2})\sin(\frac{(m+1)x}{2})}{\sin(\frac{1}{2})}$
        Since $na_n \to 0$ and $\displaystyle\sum_{n=1}^{\infty} \dfrac{sin(nx)}{n}$ is bdd( since it converges), 
        by Dirichlet's test again, $\displaystyle\sum_{n=1}^{\infty} na_n \dfrac{\sin(nx)}{n} = \displaystyle\sum_{n=1}^{\infty} a_n\sin(nx)$ converges.
